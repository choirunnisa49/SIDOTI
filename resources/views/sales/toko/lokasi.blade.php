...
<div class="heading">
    <div class="row">
        <div class="col-sm-6 col-md-6">
            <h3><button class="btn-back" onclick="javascript: history.go(-1)"><i class="fa fa-arrow-left"></i></button> Lokasi {{ $toko[0]->nama_toko }}</h3>
        </div>
        <div class="col-sm-6 col-md-6">
            <nav class="navigation-heading" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item"><a href="/sales/toko">Toko</a></li>
                    <li class="breadcrumb-item" aria-current="page">Lokasi Toko</li>
                </ol>
            </nav>
        </div>
    </div>
